 ...
 */
public final class FogOfWarMapLayerRenderSystem extends EntitySystem {
    private final int[] indexes;
    private final TiledMapRenderer tiledMapRenderer;
    private final Game2DCamera game2DCamera;

    public FogOfWarMapLayerRenderSystem(
            int priority,
            TiledMapRenderer tiledMapRenderer,
            Game2DCamera game2DCamera
    ) {
        super(priority);
        this.indexes = new int[] { MapLayerName.FogOfWarTiledLayer.getIndex() };
