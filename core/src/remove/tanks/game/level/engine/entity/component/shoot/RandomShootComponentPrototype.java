 ...
 */
public final class RandomShootComponentPrototype implements ComponentPrototype {
    private final float minShootFrequency;
    private final float maxShootFrequency;

    public RandomShootComponentPrototype(float minShootFrequency, float maxShootFrequency) {
